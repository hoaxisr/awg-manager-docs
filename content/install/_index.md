...
Начиная с keeneticOS 5.X можно установить компонент утилиты файловой системы и саму файловую систему ext и тогда появится возможность форматирования usb диска или внутреннего накопителя с помощью самого роутера, перейдя в накопители и устройства, выбираете нужный диск и три точки и после форматировать, после нужно будет подключить диск обратно.
