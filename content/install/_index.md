...
Начиная с keeneticOS 5.X можно установить компоненты утилиты файловой системы ext и файловую систему ext и тогда появится возможность форматирования usb диска или внутреннего накопителя с помощью самого роутера, перейдя в накопители и устройства, выбираете нужный диск и отключить, после три точки и потом форматировать, после нужно будет подключить диск обратно, диск готов к установке entware.
