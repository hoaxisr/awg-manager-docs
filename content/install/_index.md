...
Начиная с keeneticOS 5.X перейдя в настройки системы и изменить набор компонентов можно установить компоненты:  *утилиты файловой системы ext* и *файловую систему ext* и тогда появится возможность форматирования usb диска или внутреннего накопителя с помощью самого роутера, перейдя в накопители и устройства, выбираете нужный диск и отключить, после нажать три точки и потом форматировать, после нужно будет подключить диск обратно и диск будет готов к установке entware.
