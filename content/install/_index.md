...
Для cтарших моделей с достаточным объемом встроенной памяти (`storage:`) флешка можно не использовать — Entware установится во внутреннее хранилище.(Данный сценарий не рекомендуется производителем роутера). **Установка**  Entware на флеш-накопитель необходима также в случае использования Sing-box (VLESS/HY2/Naive) типов соединений. 
