...
Эта страница описывает AmneziaWG-туннели. Для туннелей sing-box (VLESS / Hysteria2 / NaiveProxy) — отдельный раздел [Sing-box](../singbox/).
...
{{< callout type="info" >}}
FACT-TO-VERIFY: нужно подтвердить полный список зачищаемых сущностей при удалении туннеля — кроме DNS-правил и политик доступа, что происходит с IP-маршрутами, client-route правилами (VPN для устройств) и hr-neo правилами? Становятся ли они orphan или удаляются?
{{< /callout >}}
