...
{{< callout type="info" >}}
FACT-TO-VERIFY: уточнить поведение HrNeoTab — действительно ли Targets можно упорядочивать через drag-and-drop, и корректно ли описана семантика приоритетов (правило одного домена в нескольких целях — что сработает первым)?
{{< /callout >}}
