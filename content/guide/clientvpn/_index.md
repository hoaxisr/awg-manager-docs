...
- **Туннель** — один целевой туннель. Если в выпадающем списке Туннель показывается Proxy-интерфейс sing-box-туннеля или подписки — его тоже можно выбрать как цель. Подробнее про sing-box — [Sing-box туннели](../singbox/tunnels/).
...
{{< callout type="info" >}}
FACT-TO-VERIFY: проверить, присутствует ли в форме отдельное поле Fallback (или эквивалент) — название и набор вариантов поля могли измениться в последних релизах.
{{< /callout >}}
