...
{{< callout type="info" >}}
FACT-TO-VERIFY: уточнить, кто на самом деле выполняет failover между несколькими туннелями в NDMS-правиле — awg-manager переключает цель самостоятельно, или это нативный механизм NDMS (порядок интерфейсов в правиле = порядок попыток)?
{{< /callout >}}
