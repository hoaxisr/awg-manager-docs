...
<!-- TODO-SCREENSHOT: tab.png — страница Маршрутизация с активной вкладкой Sing-box Router. -->
![Вкладка Sing-box Router](/img/guide/singbox/router/tab.png)
...
<!-- TODO-SCREENSHOT: engine-status.png — карточка статуса движка. -->
![Engine status](/img/guide/singbox/router/engine-status.png)
...
<!-- TODO-SCREENSHOT: netfilter-banner.png — баннер про отсутствующий netfilter. -->
![Netfilter missing banner](/img/guide/singbox/router/netfilter-banner.png)
...
<!-- TODO-SCREENSHOT: dns.png — подвкладка DNS. -->
![DNS](/img/guide/singbox/router/dns.png)
...
<!-- TODO-SCREENSHOT: rules.png — подвкладка правил. -->
![Правила](/img/guide/singbox/router/rules.png)
...
<!-- TODO-SCREENSHOT: connections.png — подвкладка Connections. -->
![Connections monitor](/img/guide/singbox/router/connections.png)
...
<!-- TODO-SCREENSHOT: presets.png — подвкладка Presets. -->
![Presets](/img/guide/singbox/router/presets.png)
...
<!-- TODO-SCREENSHOT: composite-outbounds.png — подвкладка Composite outbounds. -->
![Composite outbounds](/img/guide/singbox/router/composite-outbounds.png)
