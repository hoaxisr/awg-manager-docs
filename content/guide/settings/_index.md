...
![Автопроверка обновлений](/img/guide/settings/update.png)
...
![Автообновление подписок DNS-маршрутизации](/img/guide/settings/dns-route.png)
...
![Карточка Интеграции](/img/guide/settings/integrations.png)
...
![Карточка Система](/img/guide/settings/system-info.png)
...
![Виджет Обновление с кнопкой Что нового](/img/guide/settings/changelog.png)
