...
{{< pagemeta level="Расширенный" os="5.x" ui="Маршрутизация → Политики доступа" >}}
...
Sing-box Router требует свою отдельную Access Policy, к которой привязываются устройства для перехвата трафика — см. [Sing-box Router — пример настройки](../singbox/router-quickstart/#шаг-1--выбрать-источник-трафика-и-политику).
