...
Раздел доступен на уровне использования **Расширенный**.

Sing-box Router требует свою отдельную Access Policy, к которой привязываются устройства для перехвата трафика — см. [Sing-box Router — пример настройки](../singbox/router-quickstart/#шаг-1--настроить-политику-доступа).
...
{{< callout type="info" >}}
FACT-TO-VERIFY: проверить актуальные цвета индикатора устройства в политике — в текущем StatusDot могут использоваться другие оттенки/состояния (например, оранжевый для проблем), а не только зелёный/серый.
{{< /callout >}}
