...
{{< callout type="info" >}}
FACT-TO-VERIFY: уточнить, остался ли статус `broken` после внедрения state matrix v2 — в новой схеме могли появиться другие имена состояний (NeedsStart / Disabled и т.п.), и описание триггеров могло устареть.
{{< /callout >}}
